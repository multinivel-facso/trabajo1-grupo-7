...
#### Estadísticos descriptivos para la variable cluster

```{r descriptivos3, echo=FALSE, warning=FALSE, message=FALSE}
...
Se calculó la correlación intraclase para conocer qué porcentaje de la varianza del nivel educacional máximo alcanzado se debe a variables de nivel 2. El resultado fue de 0.14, lo que significa que el 14% de la varianza de la variable dependiente se asocia a la pertenencia a la comuna (NO SE SI ES A LA COMUNA O A VARIABLES DE NIVEL 2 EN GENERAL)
