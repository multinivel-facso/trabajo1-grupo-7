...
2\) Explorar si el efecto de la pertenencia a pueblos originarios sobre el logro educativo se ve moderado por la zona geográfica (urbana o rural), a través de una interacción cruzada entre variables de nivel 1 y nivel 2.

3\) Examinar si el efecto del nivel educacional promedio de los padres en la comuna sobre el nivel educativo máximo alcanzado por los individuos varía según la comuna de residencia, considerando la comuna como una variable de nivel contextual que modera dicha relación en un modelo multinivel.
...
-   **H₀:** γ02=0\\gamma\_{02} = 0γ02​=0 → No hay diferencias en el nivel educacional máximo entre zonas rurales y urbanas.

-   **H₁:** γ02\<0\\gamma\_{02} \< 0γ02​\<0 → Residir en zona rural se asocia con un menor nivel educacional máximo alcanzado.
...
En cuanto a pertenencia a zonas rurales o urbanas podemos observar que del total de la muestra (N) de 51.686, un 20.77% corresponde a zonas rurales, es decir 10.733 encuestados, mientras que 79.23% de los encuestados corresponden a zonas urbanas, es decir 40.953 personas.
...
En términos proporcionales (Tabla 5.1), cerca del 61% de los padres se ubica entre niveles “muy bajo” y “bajo”, mientras que solo un 10% alcanza niveles “medio-alto” o superiores. Esto evidencia una fuerte desigualdad en el acceso educativo entre generaciones.
